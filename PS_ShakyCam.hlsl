...
float4 main(float2 tex : TEXCOORD0) : COLOR {
	...
	sourceLocation.x = sourceLocation.x + clockSine - clockSine2 - (clockSine / 2.0) +(clockSine2/2);
	sourceLocation.y = sourceLocation.y + clockSine + clockSine2 - (clockSine / 2.0) +(clockSine2/2);
